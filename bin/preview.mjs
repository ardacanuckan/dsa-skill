...
const cliPath = path.join(here, 'dsa.mjs');
...
<body data-state="checking" data-has-artifact="false">
  <header>
    <span class="brand">DSA Preview</span>
  ...
  <main>
    ...
    <iframe id="artifact" title="Verified DSA diagram"></iframe>
  </main>
  <script>
    (function () {
      'use strict';
...
export async function startPreview(options) {
  ...
  const stagingDirectory = fs.mkdtempSync(path.join(outputDirectory, '.dsa-preview-'));
